 ...
 */
	...
	$.jstree.core.prototype = {
				...
				func = function (data, undefined) {
					...
					var dat = data.dat,
						...
						parse_nest = function (d, p, ps) {
							...
							if(d && d._id) { tmp.id = d._id.toString(); }
		...
		redraw_node : function (node, deep, is_callback) {
			...
			if((obj.icon && obj.icon !== true) || obj.icon === false || obj.original.extention) {
				if(obj.icon === false) {
					node.childNodes[1].childNodes[0].className += ' jstree-themeicon-hidden';
				} else if(obj.original.extention) {
					node.childNodes[1].childNodes[0].className = 'jstree-themeicon-custom'+obj.original.extention;
					
				} else if(obj.original.extention ===false && obj.icon.indexOf('/') === -1 && obj.icon.indexOf('.') === -1) {
